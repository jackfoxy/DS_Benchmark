...
type CoreCollectionsArrayTest() = 
    ...
    let dsGetTimeResult initData action typeDs typeData =
        TestUtil.dsGetTimeTestResult ds_benchmark.DataStructure.CoreCollectionsArray initData action typeDs typeData

    (*test all paths to data structure's getTime() function*)
    [<TestMethod>]
    member x.``CoreCollectionsArray array int`` () =
        let result = dsGetTimeResult ds_benchmark.InitData.ArrayIntAsc ds_benchmark.Action.Init (TestObj.arrInt.GetType()) (TestObj.arrInt.GetType()) 
        TestUtil.compArr (result.Data:?>int[]) (result.Result:?>int[]) -1 |> should be True

    [<TestMethod>]
    member x.``CoreCollectionsArray array string`` () =
        let result = dsGetTimeResult ds_benchmark.InitData.ArrayStringAsc ds_benchmark.Action.Init (TestObj.arrString.GetType()) (TestObj.arrString.GetType()) 
        TestUtil.compArr (result.Data:?>string[]) (result.Result:?>string[]) -1 |> should be True

    [<TestMethod>]
    member x.``CoreCollectionsArray list int`` () =
        let result = dsGetTimeResult ds_benchmark.InitData.ListIntAsc ds_benchmark.Action.Init (TestObj.arrInt.GetType()) (TestObj.listInt.GetType()) 
    ...
    member x.``CoreCollectionsArray list string`` () =
        let result = dsGetTimeResult ds_benchmark.InitData.ListStringAsc ds_benchmark.Action.Init (TestObj.arrString.GetType()) (TestObj.listString.GetType()) 
    ...
    member x.``CoreCollectionsArray seq int`` () =
        let result = dsGetTimeResult ds_benchmark.InitData.SeqIntAsc ds_benchmark.Action.Init (TestObj.arrInt.GetType()) (TestObj.seqInt.GetType()) 
    ...
    member x.``CoreCollectionsArray seq string`` () =
        let result = dsGetTimeResult ds_benchmark.InitData.SeqStringAsc ds_benchmark.Action.Init (TestObj.arrString.GetType()) (TestObj.seqString.GetType()) 
    ...
    member x.``CoreCollectionsArray seq string rnd dup`` () =
        let result = dsGetTimeResult ds_benchmark.InitData.SeqStringRndDup ds_benchmark.Action.Init (TestObj.arrString.GetType()) (TestObj.seqString.GetType()) 
        TestUtil.compArr (Seq.toArray (result.Data:?>string seq)) (result.Result:?>string[]) -1 |> should be True

    (*test remaining actions*)
    [<TestMethod>]
    member x.``CoreCollectionsArray add one int`` () =
        let result = dsGetTimeResult ds_benchmark.InitData.ArrayIntAsc ds_benchmark.Action.AddOne (TestObj.arrInt.GetType()) (TestObj.arrInt.GetType()) 
        TestUtil.compArr (result.Data:?>int[]) (result.Result:?>int[]) -1 |> should be True

    [<TestMethod>]
    member x.``CoreCollectionsArray append int`` () =
        let result = dsGetTimeResult ds_benchmark.InitData.ArrayIntAsc ds_benchmark.Action.Append (TestObj.arrInt.GetType()) (TestObj.arrInt.GetType()) 
    ...
    member x.``CoreCollectionsArray append string`` () =
        let result = dsGetTimeResult ds_benchmark.InitData.ArrayStringAsc ds_benchmark.Action.Append (TestObj.arrString.GetType()) (TestObj.arrString.GetType()) 
    ...
    member x.``CoreCollectionsArray iterate int`` () =
        let result = dsGetTimeResult ds_benchmark.InitData.ArrayIntAsc ds_benchmark.Action.Iterate (TestObj.arrInt.GetType()) (TestObj.arrInt.GetType()) 
        (result.ResultInt = (Array.length (result.Data:?>int[]))) |> should be True

    [<TestMethod>]
    member x.``CoreCollectionsArray iterate string`` () =
        let result = dsGetTimeResult ds_benchmark.InitData.ArrayStringAsc ds_benchmark.Action.Iterate (TestObj.arrString.GetType()) (TestObj.arrString.GetType()) 
...
type CoreCollectionsListTest() = 
    ...
    let dsGetTimeResult initData action typeDs typeData =
        TestUtil.dsGetTimeTestResult ds_benchmark.DataStructure.CoreCollectionsList initData action typeDs typeData

    (*test all paths to data structure's getTime() function*)
    [<TestMethod>]
    member x.``CoreCollectionsList array int`` () =
        let result = dsGetTimeResult ds_benchmark.InitData.ArrayIntAsc ds_benchmark.Action.Init (TestObj.listInt.GetType()) (TestObj.arrInt.GetType()) 
    ...
    member x.``CoreCollectionsList array string`` () =
        let result = dsGetTimeResult ds_benchmark.InitData.ArrayStringAsc ds_benchmark.Action.Init (TestObj.listString.GetType()) (TestObj.arrString.GetType()) 
    ...
    member x.``CoreCollectionsList list int`` () =
        let result = dsGetTimeResult ds_benchmark.InitData.ListIntAsc ds_benchmark.Action.Init  (TestObj.listInt.GetType()) (TestObj.listInt.GetType()) 
    ...
    member x.``CoreCollectionsList list string`` () =
        let result = dsGetTimeResult ds_benchmark.InitData.ListStringAsc ds_benchmark.Action.Init (TestObj.listString.GetType()) (TestObj.listString.GetType()) 
    ...
    member x.``CoreCollectionsList seq int`` () =
        let result = dsGetTimeResult ds_benchmark.InitData.SeqIntAsc ds_benchmark.Action.Init (TestObj.listInt.GetType()) (TestObj.seqInt.GetType()) 
    ...
    member x.``CoreCollectionsList seq string`` () =
        let result = dsGetTimeResult ds_benchmark.InitData.SeqStringAsc ds_benchmark.Action.Init (TestObj.listString.GetType()) (TestObj.seqString.GetType()) 
    ...
    member x.``CoreCollectionsList add one int`` () =
        let result = dsGetTimeResult ds_benchmark.InitData.ArrayIntAsc ds_benchmark.Action.AddOne (TestObj.listInt.GetType()) (TestObj.arrInt.GetType()) 
    ...
    member x.``CoreCollectionsList append int`` () =
        let result = dsGetTimeResult ds_benchmark.InitData.ArrayIntAsc ds_benchmark.Action.Append (TestObj.listInt.GetType()) (TestObj.arrInt.GetType()) 
        let a = result.Data:?>int[]
    ...
    member x.``CoreCollectionsList append string`` () =
        let result = dsGetTimeResult ds_benchmark.InitData.ArrayStringAsc ds_benchmark.Action.Append (TestObj.listString.GetType()) (TestObj.arrString.GetType()) 
        let a = result.Data:?>string[]
    ...
    member x.``CoreCollectionsList iterate int`` () =
        let result = dsGetTimeResult ds_benchmark.InitData.ArrayIntAsc ds_benchmark.Action.Iterate (TestObj.listInt.GetType()) (TestObj.arrInt.GetType()) 
        (result.ResultInt = (Array.length (result.Data:?>int[]))) |> should be True

    [<TestMethod>]
    member x.``CoreCollectionsList iterate string`` () =
        let result = dsGetTimeResult ds_benchmark.InitData.ArrayStringAsc ds_benchmark.Action.Iterate (TestObj.listString.GetType()) (TestObj.arrString.GetType()) 
        (result.ResultInt = (Array.length (result.Data:?>string[]))) |> should be True
    (*TO DO: beefier lookup and update unit tests*)
    [<TestMethod>]
...
type CoreCollectionsMapTest() = 
    ...
    let dsGetTimeResult initData action typeDs typeData =
        TestUtil.dsGetTimeTestResult ds_benchmark.DataStructure.CoreCollectionsMap initData action typeDs typeData

    (*test all paths to data structure's getTime() function*)
    [<TestMethod>]
    member x.``CoreCollectionsMap array int`` () =
        let result = dsGetTimeResult  ds_benchmark.InitData.ArrayIntAsc ds_benchmark.Action.Init (TestObj.mapInt.GetType()) (TestObj.zipArrInt.GetType()) 
    ...
    member x.``CoreCollectionsMap array string`` () =
        let result = dsGetTimeResult   ds_benchmark.InitData.ArrayStringAsc ds_benchmark.Action.Init (TestObj.mapString.GetType()) (TestObj.zipArrString.GetType()) 
    ...
    member x.``CoreCollectionsMap list int`` () =
        let result = dsGetTimeResult   ds_benchmark.InitData.ListIntAsc ds_benchmark.Action.Init (TestObj.mapInt.GetType()) (TestObj.zipListInt.GetType()) 
    ...
    member x.``CoreCollectionsMap list string`` () =
        let result = dsGetTimeResult   ds_benchmark.InitData.ListStringAsc ds_benchmark.Action.Init (TestObj.mapString.GetType()) (TestObj.zipListString.GetType()) 
    ...
    member x.``CoreCollectionsMap seq int`` () =
        let result = dsGetTimeResult   ds_benchmark.InitData.SeqIntAsc ds_benchmark.Action.Init (TestObj.mapInt.GetType()) (TestObj.zipSeqInt.GetType()) 
    ...
    member x.``CoreCollectionsMap seq string`` () =
        let result = dsGetTimeResult   ds_benchmark.InitData.SeqStringAsc ds_benchmark.Action.Init (TestObj.mapString.GetType()) (TestObj.zipSeqString.GetType()) 
    ...
    member x.``CoreCollectionsMap add one int`` () =
        let result = dsGetTimeResult ds_benchmark.InitData.ArrayIntAsc ds_benchmark.Action.AddOne (TestObj.mapInt.GetType()) (TestObj.zipArrInt.GetType()) 
        TestUtil.compArr2 (result.Data:?>(int*int)[]) (Map.toArray (result.Result:?>Map<int,int>)) -1 |> should be True

    [<TestMethod>]
    member x.``CoreCollectionsMap append int`` () =
        let result = dsGetTimeResult ds_benchmark.InitData.ArrayIntAsc ds_benchmark.Action.Append (TestObj.mapInt.GetType()) (TestObj.zipArrInt.GetType()) 
    ...
    member x.``CoreCollectionsMap append string`` () =
        let result = dsGetTimeResult ds_benchmark.InitData.ArrayStringAsc ds_benchmark.Action.Append (TestObj.mapString.GetType()) (TestObj.zipArrString.GetType()) 
    ...
    member x.``CoreCollectionsMap iterate int`` () =
        let result = dsGetTimeResult  ds_benchmark.InitData.ArrayIntAsc ds_benchmark.Action.Iterate (TestObj.mapInt.GetType()) (TestObj.zipArrInt.GetType()) 
        (result.ResultInt = (Array.length (result.Data:?>(int*int)[]))) |> should be True

    [<TestMethod>]
    member x.``CoreCollectionsMap iterate string`` () =
        let result = dsGetTimeResult  ds_benchmark.InitData.ArrayStringAsc ds_benchmark.Action.Iterate (TestObj.mapString.GetType()) (TestObj.zipArrString.GetType()) 
...
type CoreCollectionsSetTest() = 
    ...
    let dsGetTimeResult initData action typeDs typeData =
        TestUtil.dsGetTimeTestResult ds_benchmark.DataStructure.CoreCollectionsSet initData action typeDs typeData

    (*test all paths to data structure's getTime() function*)
    [<TestMethod>]
    member x.``CoreCollectionsSet array int`` () =
        let result = dsGetTimeResult ds_benchmark.InitData.ArrayIntAsc ds_benchmark.Action.Init (TestObj.setInt.GetType()) (TestObj.arrInt.GetType()) 
    ...
    member x.``CoreCollectionsSet array string`` () =
        let result = dsGetTimeResult ds_benchmark.InitData.ArrayStringAsc ds_benchmark.Action.Init (TestObj.setString.GetType()) (TestObj.arrString.GetType()) 
    ...
    member x.``CoreCollectionsSet list int`` () =
        let result = dsGetTimeResult ds_benchmark.InitData.ListIntAsc ds_benchmark.Action.Init (TestObj.setInt.GetType()) (TestObj.listInt.GetType()) 
    ...
    member x.``CoreCollectionsSet list string`` () =
        let result = dsGetTimeResult ds_benchmark.InitData.ListStringAsc ds_benchmark.Action.Init (TestObj.setString.GetType()) (TestObj.listString.GetType()) 
    ...
    member x.``CoreCollectionsSet seq int`` () =
        let result = dsGetTimeResult ds_benchmark.InitData.SeqIntAsc ds_benchmark.Action.Init (TestObj.setInt.GetType()) (TestObj.seqInt.GetType()) 
    ...
    member x.``CoreCollectionsSet seq string`` () =
        let result = dsGetTimeResult ds_benchmark.InitData.SeqStringAsc ds_benchmark.Action.Init (TestObj.setString.GetType()) (TestObj.seqString.GetType()) 
        TestUtil.compArr (Seq.toArray (result.Data:?>seq<string>)) (Set.toArray (result.Result:?>Set<string>)) -1 |> should be True

    (*test remaining actions*)
    [<TestMethod>]
    member x.``CoreCollectionsMap add one int`` () =
        let result = dsGetTimeResult ds_benchmark.InitData.ArrayIntAsc ds_benchmark.Action.AddOne (TestObj.setInt.GetType()) (TestObj.arrInt.GetType()) 
        TestUtil.compArr (result.Data:?>(int)[]) (Set.toArray (result.Result:?>Set<int>)) -1 |> should be True

    [<TestMethod>]
    member x.``CoreCollectionsSet append int`` () =
        let result = dsGetTimeResult ds_benchmark.InitData.ArrayIntAsc ds_benchmark.Action.Append (TestObj.setInt.GetType()) (TestObj.arrInt.GetType()) 
        let a = result.Data:?>int[]
    ...
    member x.``CoreCollectionsSet append string`` () =
        let result = dsGetTimeResult ds_benchmark.InitData.ArrayStringAsc ds_benchmark.Action.Append (TestObj.setString.GetType()) (TestObj.arrString.GetType()) 
        let a = result.Data:?>string[]
    ...
    member x.``CoreCollectionsSet iterate int`` () =
        let result = dsGetTimeResult ds_benchmark.InitData.ArrayIntAsc ds_benchmark.Action.Iterate (TestObj.setInt.GetType()) (TestObj.arrInt.GetType()) 
        (result.ResultInt = (Array.length (result.Data:?>int[]))) |> should be True

    [<TestMethod>]
    member x.``CoreCollectionsSet iterate string`` () =
        let result = dsGetTimeResult ds_benchmark.InitData.ArrayStringAsc ds_benchmark.Action.Iterate (TestObj.setString.GetType()) (TestObj.arrString.GetType()) 
        (result.ResultInt = (Array.length (result.Data:?>string[]))) |> should be True
    (*TO DO: beefier lookup and update unit tests*)
    [<TestMethod>]
